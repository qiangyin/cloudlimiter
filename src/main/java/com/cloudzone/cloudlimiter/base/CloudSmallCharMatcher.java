...
@CloudGwtIncompatible("no precomputation is done in GWT")
final class CloudSmallCharMatcher extends CloudCharMatcher {
    ...
    private CloudSmallCharMatcher(char[] table, long filter, boolean containsZero, String description) {
        super(description);
        this.table = table;
        this.filter = filter;
    ...
    static CloudCharMatcher from(BitSet chars, String description) {
        long filter = 0L;
        ...
        return new CloudSmallCharMatcher(table, filter, containsZero, description);
    }
